...
//        Mapbox.getInstance(this, getResources().getString(R.string.mapbox_access_token));
        ...
        dialog.show();
        String json = getIntent().getStringExtra("fallResponse");

        Gson gson = new Gson();
        fallResponse = gson.fromJson(json, FallResponse.class);


        txtName.setText("Fall Detection");
...
//                initSearchFab();
                ...
                destination = Point.fromLngLat(Double.parseDouble(fallResponse.longitude), Double.parseDouble(fallResponse.latitude));
